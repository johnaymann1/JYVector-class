...
//======================================================================================================================
    ...
    bool operator==(const JYVector<T>&); // Return true if they are equal
    bool operator< (const JYVector<T>&); // Compares item by item return true if first different item in this is < in other
...
//======================================================================================================================
    //-------------------------NOT DONE YET----------------------------
    friend std::ostream& operator<<(std::ostream& out, const JYVector<T>& vec);
